from core.layers import convolution_2d, deconvolution_2d, prelu
...
class V_Net(object):
    ...
    def inference_op(self, _input):
        ...
        with tf.variable_scope('contracting_path'):
            ...
            if input_channels == 1:
                c0 = tf.tile(_input, [1, 1, 1, n_channels])
            else:
                with tf.variable_scope('level_0'):
                    c0 = prelu(convolution_2d(_input, [5, 5, input_channels, n_channels], [1, 1, 1, 1]))
